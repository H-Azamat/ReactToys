...
function Pagination() {
    return (
        <div className="pagination container">
            ...
            <div className="pagination-item active"><span className="pagination-item--text">1</span></div>
            <div className="pagination-item"><span className="pagination-item--text">2</span></div>
            <div className="pagination-item"><span className="pagination-item--text">3</span></div>
            <div className="pagination-item"><span className="pagination-item--text">4</span></div>
            <div className="pagination-item"><span className="pagination-item--text">...</span></div>
            <div className="pagination-item"><span className="pagination-item--text">10</span></div>
            <div className="pagination-item">
                <svg width="29" height="28" viewBox="0 0 29 28" fill="#0099FF" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0)">
